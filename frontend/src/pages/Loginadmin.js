...
//     // Send login request
//     try {
//       const response = await axios.post('http://localhost:7000/api/v1/admin/adminLogin', {
//         email,
//         password,
//       });
...
//     try {       
//       const response = await axios.post('http://localhost:7000/api/v1/admin/adminLogin', sendData);       
...
//       <div className='form-box login' style={{ backgroundImage: `url(${Log})` }}>         
//         <form onSubmit={HandleLogin}>           
//           <h1>Admin Login</h1>                       {/* Display error if any */}           
//           {error && <div className="error-message">{error}</div>}                      
...
//             <button onClick={() => navigate('/adminfirst')}>Go Now</button>
//           </div>
//         </div>
//       )}
